...
const LatestProducts = ({ products, handleAddRemoveFromWishlist }) => {
  ...
  // Sort products by `updatedAt` in descending order and take the top 8
  const latestProducts = [...products] // Make a shallow copy to avoid mutating the original array
  ...
  return (
    ...
    <div className='text-center py-4 text-3xl'>
                <Titile text1={'LATEST'} text2={'PRODUCTS'} />
